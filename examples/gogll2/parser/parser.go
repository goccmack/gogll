...
import (
	...
	"gogll/examples/gogll2/goutil/bsr"
	"gogll/examples/gogll2/goutil/md"
	"gogll/examples/gogll2/parser/slot"
...
func Parse(I []byte) (error, []*ParseError) {
	...
	for !R.empty() {
		...
		case slot.Head1R0: // Head : ∙NonTerminal

			call(slot.Head1R1, cU, cI)
		case slot.Head1R1: // Head : NonTerminal ∙
		...
		case slot.NTChar2R0: // NTChar : ∙anyof(!\"#$%&*+-=@^_)
			...
			call(slot.NTChar2R1, cU, cI)
		case slot.NTChar2R1: // NTChar : anyof(!\"#$%&*+-=@^_) ∙
		...
		case slot.EscapedChar0R0: // EscapedChar : ∙"
			...
			call(slot.EscapedChar0R1, cU, cI)
		case slot.EscapedChar0R1: // EscapedChar : " ∙
		...
		case slot.String0R0: // String : ∙" StringChars "
			...
			call(slot.String0R1, cU, cI)
		case slot.String0R1: // String : " ∙StringChars "
		...
		case slot.String0R2: // String : " StringChars ∙"
			...
			call(slot.String0R3, cU, cI)
		case slot.String0R3: // String : " StringChars " ∙
		...
		case slot.StringChars0R0: // StringChars : ∙not(\"\")
			...
			call(slot.StringChars0R1, cU, cI)
		case slot.StringChars0R1: // StringChars : not(\"\") ∙
		...
		case slot.SepChar1R0: // SepChar : ∙anyof(\"\n\t)
			...
			call(slot.SepChar1R1, cU, cI)
		case slot.SepChar1R1: // SepChar : anyof(\"\n\t) ∙
