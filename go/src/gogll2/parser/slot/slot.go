...
var slots = map[Label]*Slot{ 
	...
	GoGLL0R0:&Slot{"GoGLL", 0, 0, []string{ `Package`,`Rules` }, GoGLL0R0 },
	GoGLL0R1:&Slot{"GoGLL", 0, 1, []string{ `Package`,`Rules` }, GoGLL0R1 },
	GoGLL0R2:&Slot{"GoGLL", 0, 2, []string{ `Package`,`Rules` }, GoGLL0R2 },
	Head0R0:&Slot{"Head", 0, 0, []string{ `NonTerminal` }, Head0R0 },
	Head0R1:&Slot{"Head", 0, 1, []string{ `NonTerminal` }, Head0R1 },
	...
	Package0R0:&Slot{"Package", 0, 0, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R0 },
	Package0R1:&Slot{"Package", 0, 1, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R1 },
	Package0R2:&Slot{"Package", 0, 2, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R2 },
	Package0R3:&Slot{"Package", 0, 3, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R3 },
	Package0R4:&Slot{"Package", 0, 4, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R4 },
	Package0R5:&Slot{"Package", 0, 5, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R5 },
	Package0R6:&Slot{"Package", 0, 6, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R6 },
	Package0R7:&Slot{"Package", 0, 7, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R7 },
	Package0R8:&Slot{"Package", 0, 8, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R8 },
	Package0R9:&Slot{"Package", 0, 9, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R9 },
	Package0R10:&Slot{"Package", 0, 10, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R10 },
	Package0R11:&Slot{"Package", 0, 11, []string{ `SepE`,`p`,`a`,`c`,`k`,`a`,`g`,`e`,`Sep`,`String`,`SepE` }, Package0R11 },
	Rule0R0:&Slot{"Rule", 0, 0, []string{ `Head`,`SepE`,`:`,`SepE`,`Alternates`,`;` }, Rule0R0 },
	Rule0R1:&Slot{"Rule", 0, 1, []string{ `Head`,`SepE`,`:`,`SepE`,`Alternates`,`;` }, Rule0R1 },
	Rule0R2:&Slot{"Rule", 0, 2, []string{ `Head`,`SepE`,`:`,`SepE`,`Alternates`,`;` }, Rule0R2 },
	Rule0R3:&Slot{"Rule", 0, 3, []string{ `Head`,`SepE`,`:`,`SepE`,`Alternates`,`;` }, Rule0R3 },
	Rule0R4:&Slot{"Rule", 0, 4, []string{ `Head`,`SepE`,`:`,`SepE`,`Alternates`,`;` }, Rule0R4 },
	Rule0R5:&Slot{"Rule", 0, 5, []string{ `Head`,`SepE`,`:`,`SepE`,`Alternates`,`;` }, Rule0R5 },
	Rule0R6:&Slot{"Rule", 0, 6, []string{ `Head`,`SepE`,`:`,`SepE`,`Alternates`,`;` }, Rule0R6 },
	...
	StringChars0R0:&Slot{"StringChars", 0, 0, []string{ `not("\"")` }, StringChars0R0 },
...
var slotIndex = map[Index]Label { 
	...
	Index{ "NonTerminal",0,2 }: NonTerminal0R2,
...
var alternates = map[string][]Label{ 
	...
	"Head":[]Label{ Head0R0 },
	"Alternate":[]Label{ Alternate0R0,Alternate1R0,Alternate2R0 },
	...
	"StringChars":[]Label{ StringChars0R0,StringChars1R0 },
	"Rule":[]Label{ Rule0R0 },
