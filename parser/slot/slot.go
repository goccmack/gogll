...
var slots = map[Label]*Slot{ 
	...
	CharLiteral0R0:&Slot{"CharLiteral", 0, 0, []string{ `\'`,`\\`,`anyof("nrt\\'\"")`,`\'` }, CharLiteral0R0 },
	CharLiteral0R1:&Slot{"CharLiteral", 0, 1, []string{ `\'`,`\\`,`anyof("nrt\\'\"")`,`\'` }, CharLiteral0R1 },
	CharLiteral0R2:&Slot{"CharLiteral", 0, 2, []string{ `\'`,`\\`,`anyof("nrt\\'\"")`,`\'` }, CharLiteral0R2 },
	CharLiteral0R3:&Slot{"CharLiteral", 0, 3, []string{ `\'`,`\\`,`anyof("nrt\\'\"")`,`\'` }, CharLiteral0R3 },
	CharLiteral0R4:&Slot{"CharLiteral", 0, 4, []string{ `\'`,`\\`,`anyof("nrt\\'\"")`,`\'` }, CharLiteral0R4 },
	...
	NonTerminal0R0:&Slot{"NonTerminal", 0, 0, []string{ `letter` }, NonTerminal0R0 },
	NonTerminal0R1:&Slot{"NonTerminal", 0, 1, []string{ `letter` }, NonTerminal0R1 },
	NonTerminal1R0:&Slot{"NonTerminal", 1, 0, []string{ `letter`,`NTChars` }, NonTerminal1R0 },
	NonTerminal1R1:&Slot{"NonTerminal", 1, 1, []string{ `letter`,`NTChars` }, NonTerminal1R1 },
	NonTerminal1R2:&Slot{"NonTerminal", 1, 2, []string{ `letter`,`NTChars` }, NonTerminal1R2 },
...
var slotIndex = map[Index]Label { 
	...
	Index{ "NonTerminal",1,0 }: NonTerminal1R0,
	Index{ "NonTerminal",1,1 }: NonTerminal1R1,
	Index{ "NonTerminal",1,2 }: NonTerminal1R2,
	...
	Index{ "StartSymbol",0,0 }: StartSymbol0R0,
...
var alternates = map[string][]Label{ 
	...
	"NonTerminal":[]Label{ NonTerminal0R0,NonTerminal1R0 },
	...
	"StartSymbol":[]Label{ StartSymbol0R0 },
